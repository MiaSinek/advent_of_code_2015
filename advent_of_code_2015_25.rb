...
# STEPS:
# 1. get the guest to guest happyness from the guest list
# 2. get the guests from the guest list
# 3. get all possible seating orders
# 4. get the max seating happyness
...
def get_guests_from(guest_list)
  @happyness_ary.map { |guest1, guest2, happyness| [guest1, guest2] }.flatten.uniq
end
